...
import { Search, Flame, Check, X, AlertTriangle, RefreshCw, ExternalLink } from 'lucide-react';
    ...
    <div className="bg-white border border-slate-200/90 rounded-2xl shadow-xs p-3.5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-1 max-w-sm">
          ...
          <Link
            to="/inventory"
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-xl bg-orange-50 border border-orange-200 text-orange-800 hover:bg-orange-100 text-xs font-bold transition-all shadow-2xs whitespace-nowrap"
            title="Buka Pengurusan Inventori Penuh"
          >
