            ...
            <div className="flex flex-col gap-2 items-end">
              ...
              {highlight && (
                <button 
                  ...
                  className={`${isModified ? 'bg-rose-600 hover:bg-rose-700 text-white animate-pulse border-2 border-white' : 'bg-orange-500 hover:bg-orange-600 text-white shadow-sm'} text-xs font-black px-3.5 py-1.5 rounded-xl transition-all active:scale-95 whitespace-nowrap`}
                >
